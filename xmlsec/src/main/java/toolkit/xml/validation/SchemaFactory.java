...
package toolkit.xml.validation;
...
/**
 * Factory that creates {@link toolkit.xml.validation.Schema} objects&#x2E; Entry-point to
 * the validation API.
 *
 * <p>
...
public abstract class SchemaFactory {
     ...
     *     <code>"SchemaFactory:<i>schemaLanguage</i>"</code>
     ...
     *     <code>SchemaFactory</code> in the resource directory META-INF/services.
     ...
     * 
     * <p>
     * Applications can call this method even during a {@link toolkit.xml.validation.Schema}
     * is being parsed. 
     * 
     * <p>
     ...
     * inherited to {@link toolkit.xml.validation.Schema}s, {@link Validator}s, or
     * {@link toolkit.xml.validation.ValidatorHandler}s that are created from this {@link SchemaFactory}.
     * 
     * 
     * @param   errorHandler
     ...
     */
    public toolkit.xml.validation.Schema newSchema(Source schema) throws SAXException {
     ...
     * @throws NullPointerException if <tt>schema</tt> is null.
     */
    public toolkit.xml.validation.Schema newSchema(File schema) throws SAXException {
     ...
     * @throws NullPointerException if <tt>schema</tt> is null.
     */
    public toolkit.xml.validation.Schema newSchema(URL schema) throws SAXException {
     ...
     * 
     * @return
     *      Always return a non-null valid {@link toolkit.xml.validation.Schema} object.
     *      Note that when an error has been reported, there is no
     *      guarantee that the returned {@link toolkit.xml.validation.Schema} object is
     *      meaningful.
     * 
     * @throws SAXException
     ...
     */
    public abstract toolkit.xml.validation.Schema newSchema(Source[] schemas) throws SAXException;
    
    /**
     * Creates a special {@link toolkit.xml.validation.Schema} object.
     * 
     * <p>
     * The exact semantics of the returned {@link toolkit.xml.validation.Schema} object depends
     ...
     * <h2>W3C XML Schema 1.0</h2>
     * <p>
     * For XML Schema, this method creates a {@link toolkit.xml.validation.Schema} object that
     * performs validation by using location hints specified in documents.
     * 
     * <p>
     * The returned {@link toolkit.xml.validation.Schema} object assumes that if documents
     ...
     * 
     * @return
     *      Always return non-null valid {@link toolkit.xml.validation.Schema} object.
     * 
     * @throws UnsupportedOperationException
     ...
     */
    public abstract toolkit.xml.validation.Schema newSchema() throws SAXException;
}
