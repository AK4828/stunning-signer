...
public class MethodResolver
{
  ...
  private final static ConversionInfo[] m_javaObjConversions = {
    ...
    new ConversionInfo(String.class, 18)
  };
  ...
  private final static ConversionInfo[] m_booleanConversions = {
    ...
    new ConversionInfo(Boolean.class, 1),
    new ConversionInfo(Object.class, 2),
    new ConversionInfo(String.class, 3)
  };
  ...
  private final static ConversionInfo[] m_numberConversions = {
    ...
    new ConversionInfo(Double.class, 1),
    ...
    new ConversionInfo(String.class, 10),
    new ConversionInfo(Object.class, 11)
  };
  ...
  private final static ConversionInfo[] m_stringConversions = {
    new ConversionInfo(String.class, 0),
    new ConversionInfo(Object.class, 1),
  ...
  private final static ConversionInfo[] m_rtfConversions = {
    ...
    new ConversionInfo(NodeList.class, 1),
    new ConversionInfo(Node.class, 2),
    new ConversionInfo(String.class, 3),
    new ConversionInfo(Object.class, 5),
