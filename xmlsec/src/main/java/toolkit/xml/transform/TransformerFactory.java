...
package toolkit.xml.transform;

import toolkit.xml.XMLConstants;
import toolkit.xml.transform.dom.DOMSource;
import toolkit.xml.transform.sax.SAXSource;
import toolkit.xml.transform.stax.StAXSource;
import toolkit.xml.transform.stream.StreamSource;

/**
 * <p>A TransformerFactory instance can be used to create
 * {@link toolkit.xml.transform.Transformer} and
 * {@link toolkit.xml.transform.Templates} objects.</p>
 *
 * <p>The system property that determines which Factory implementation
 * to create is named <code>"TransformerFactory"</code>.
...
public abstract class TransformerFactory {
    ...
    */
     ...
     * <ul>
     * <li>
     * Use the <code>TransformerFactory</code> system
     * property.
     * </li>
     * <li>
     ...
     * <code>META-INF/services/TransformerFactory</code>
     ...
     *   {@link SAXSource SAXSource},
     *   {@link DOMSource DOMSource} and
     *   {@link StAXSource StAXSource}.
     *
     * @return A <code>Transformer</code> object that may be used to perform
     *   a transformation in a single <code>Thread</code>, never
     *   <code>null</code>.
     *
     * @throws toolkit.xml.transform.TransformerConfigurationException Thrown if there are errors when
     ...
     */
    public abstract toolkit.xml.transform.Transformer newTransformer(toolkit.xml.transform.Source source)
        throws toolkit.xml.transform.TransformerConfigurationException;
     ...
     *
     * @exception toolkit.xml.transform.TransformerConfigurationException Thrown if it is not
     *   possible to create a <code>Transformer</code> instance.
     */
    public abstract toolkit.xml.transform.Transformer newTransformer()
        throws toolkit.xml.transform.TransformerConfigurationException;
     ...
     * purposes, never null.
     *
     * @exception toolkit.xml.transform.TransformerConfigurationException May throw this during the
     * parse when it is constructing the Templates object and fails.
     */
    public abstract toolkit.xml.transform.Templates newTemplates(toolkit.xml.transform.Source source)
        throws toolkit.xml.transform.TransformerConfigurationException;
     ...
     * 
     * @throws toolkit.xml.transform.TransformerConfigurationException An <code>Exception</code>
     ...
     */
    public abstract toolkit.xml.transform.Source getAssociatedStylesheet(
        toolkit.xml.transform.Source source,
        String media,
        String title,
        String charset)
        throws toolkit.xml.transform.TransformerConfigurationException;
     ...
     * or null.
     */
    public abstract void setURIResolver(toolkit.xml.transform.URIResolver resolver);
     ...
     */
    public abstract toolkit.xml.transform.URIResolver getURIResolver();
	 ...
	 * An {@link toolkit.xml.transform.TransformerConfigurationException} is thrown if this <code>TransformerFactory</code> or the
	 ...
	 *     {@link toolkit.xml.transform.ErrorListener#fatalError(toolkit.xml.transform.TransformerException exception)}.
	 *     See {@link  #setErrorListener(toolkit.xml.transform.ErrorListener listener)}.
	 *   </li>
	 *   <li>
	 ...
	 *  
	 * @throws toolkit.xml.transform.TransformerConfigurationException if this <code>TransformerFactory</code>
     ...
     */
    public abstract void setErrorListener(toolkit.xml.transform.ErrorListener listener);
     ...
     */
    public abstract toolkit.xml.transform.ErrorListener getErrorListener();
