...
import toolkit.xml.xpath.*;
import toolkit.xml.xpath.XPathVariableResolver;
import toolkit.xml.xpath.XPathExpression;
 ...
 * XPath interface. This provide simple access to the results
 ...
 */
public class XPathImpl implements toolkit.xml.xpath.XPath {
    ...
    private static toolkit.xml.parsers.DocumentBuilder getParser() {
        try {
            ...
            // - KK
            toolkit.xml.parsers.DocumentBuilderFactory dbf = toolkit.xml.parsers.DocumentBuilderFactory.newInstance();
            dbf.setNamespaceAware( true );
            dbf.setValidating( false );
            return dbf.newDocumentBuilder();
        } catch (toolkit.xml.parsers.ParserConfigurationException e) {
