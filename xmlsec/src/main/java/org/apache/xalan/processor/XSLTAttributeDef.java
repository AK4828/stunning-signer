...
public class XSLTAttributeDef
{
 ...
 /**
   ...
   * {@link TransformerException}, if there is a syntax error
   ...
   * {@link TransformerException} if the expression
   ...
   *
   * @throws org.xml.sax.SAXException that wraps a
   * {@link TransformerException} if the match pattern
   * string contains a syntax error.
   */
 ...
 /**
   ...
   *
   * @throws org.xml.sax.SAXException that wraps a
   * {@link TransformerException} if one of the match pattern
