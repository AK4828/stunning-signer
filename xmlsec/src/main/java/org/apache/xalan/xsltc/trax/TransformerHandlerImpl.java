...
public class TransformerHandlerImpl implements TransformerHandler, DeclHandler {
    ...
    /**
     * Implements TransformerHandler.getSystemId()
    ...
    /**
     * Implements TransformerHandler.setSystemId()
     * Get the base ID (URI or system ID) from where relative URLs will be
     * resolved.
    ...
    /**
     * Implements TransformerHandler.getTransformer()
    ...
    /**
     * Implements TransformerHandler.setResult()
