...
public abstract class Transformer {
	 ...
	 * {@link TransformerFactory#newTransformer(toolkit.xml.transform.Source source)} or
	 * {@link toolkit.xml.transform.Templates#newTransformer()}.
	 * <code>reset()</code> is designed to allow the reuse of existing <code>Transformer</code>s
	 * thus saving resources associated with the creation of new <code>Transformer</code>s.</p>
	 * 
	 * <p>The reset <code>Transformer</code> is not guaranteed to have the same {@link toolkit.xml.transform.URIResolver}
	 * or {@link toolkit.xml.transform.ErrorListener} <code>Object</code>s, e.g. {@link Object#equals(Object obj)}.
     ...
     *   <code>xmlSource</code>.
     *
     * @throws toolkit.xml.transform.TransformerException If an unrecoverable error occurs
     *   during the course of the transformation.
     */
    public abstract void transform(toolkit.xml.transform.Source xmlSource, toolkit.xml.transform.Result outputTarget)
        throws toolkit.xml.transform.TransformerException;
     ...
     *
     * @see toolkit.xml.transform.OutputKeys
     * @see Properties
     *
     */
