 ...
 * after a call to {@link #fatalError(toolkit.xml.transform.TransformerException exception)}.</p>
 *
...
public interface ErrorListener {
     ...
     *
     * @throws toolkit.xml.transform.TransformerException if the application
     * chooses to discontinue the transformation.
     *
     * @see toolkit.xml.transform.TransformerException
     */
    public abstract void warning(toolkit.xml.transform.TransformerException exception)
     ...
     * @see toolkit.xml.transform.TransformerException
     */
    public abstract void error(toolkit.xml.transform.TransformerException exception)
        throws toolkit.xml.transform.TransformerException;
     ...
     * @see toolkit.xml.transform.TransformerException
     */
    public abstract void fatalError(toolkit.xml.transform.TransformerException exception)
        throws toolkit.xml.transform.TransformerException;
}
