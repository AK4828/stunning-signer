...
package toolkit.xml.datatype;

import java.math.BigInteger;
import java.math.BigDecimal;
import java.util.GregorianCalendar;

import toolkit.xml.XMLConstants;

/**
 * <p>Factory that creates new <code>toolkit.xml.datatype</code> <code>Object</code>s that map XML to/from Java <code>Object</code>s.</p>
 * 
 ...
 * <ol>
 *    <li>
 *      If the system property specified by {@link #DATATYPEFACTORY_PROPERTY}, "<code>DatatypeFactory</code>",
 ...
 *      {@link #DATATYPEFACTORY_IMPLEMENTATION_CLASS}, "<code>toolkit.xml.datatype.DatatypeFactoryImpl</code>".
 *      Any Exception thrown during the instantiation process is wrapped as a {@link DatatypeConfigurationException}.
 *    </li>
 * </ol> 
 * 
...
public abstract class DatatypeFactory {
     ...
     * 
     * <p>Default value is <code>DatatypeFactory</code>.</p>
     */
    public static final String DATATYPEFACTORY_PROPERTY = "DatatypeFactory";
     ...
     * </blockquote>
     * <p>All six values are set and available from the created {@link toolkit.xml.datatype.Duration}</p>
     * 
     ...
     */
    public abstract toolkit.xml.datatype.Duration newDuration(final String lexicalRepresentation);
     ...
     * and are available using the <code>get</code> methods of  the created {@link toolkit.xml.datatype.Duration}.
     ...
     *   </li>
     *   <li>{@link toolkit.xml.datatype.XMLGregorianCalendar}  Date/Time Datatype Field Mapping Between XML Schema 1.0 and Java Representation</li>
     * </ul>
     * 
     ...
     * so the result of {@link toolkit.xml.datatype.Duration#getMonths()} and {@link toolkit.xml.datatype.Duration#getDays()} can be influenced.</p>
     * 
     ...
     */
    public abstract toolkit.xml.datatype.Duration newDuration(final long durationInMilliSeconds);
     ...
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     */
    public abstract toolkit.xml.datatype.Duration newDuration(
     ...
     * specifying the <code>Duration</code> as isPositive, years, months, days, hours, minutes, seconds.</p>
     * 
     * <p>A {@link toolkit.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} value indicates that field is not set.</p>
     * 
     * @param isPositive Set to <code>false</code> to create a negative duration. When the length
     *   of the duration is zero, this parameter will be ignored.
     * @param years of this <code>Duration</code>
     ...
     *   BigDecimal seconds)
     */
    public toolkit.xml.datatype.Duration newDuration(
            final boolean isPositive,
            final int years,
            final int months,
            final int days,
        ...
        BigInteger realYears = (years != toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) years) : null;

        // months may not be set
        BigInteger realMonths = (months != toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) months) : null;

        // days may not be set
        BigInteger realDays = (days != toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) days) : null;

        // hours may not be set
        BigInteger realHours = (hours != toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) hours) : null;

        // minutes may not be set
        BigInteger realMinutes = (minutes != toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) minutes) : null;

        // seconds may not be set
        BigDecimal realSeconds = (seconds != toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigDecimal.valueOf((long) seconds) : null;
     ...
     * 
     * <p>All four values are set and available from the created {@link toolkit.xml.datatype.Duration}</p>
     * 
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small values.
     * An {@link UnsupportedOperationException} will be thrown with a message indicating implementation limits
     ...
     * @throws NullPointerException If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public toolkit.xml.datatype.Duration newDurationDayTime(final String lexicalRepresentation) {
     ...
     * This is important as there are variations in the Gregorian Calendar,
     * e.g. leap years have different days in the month = {@link java.util.Calendar#FEBRUARY}
     * so the result of {@link toolkit.xml.datatype.Duration#getDays()} can be influenced.</p>
     * 
     ...
     */
    public toolkit.xml.datatype.Duration newDurationDayTime(final long durationInMilliseconds) {
        long _durationInMilliseconds = durationInMilliseconds;
        if (_durationInMilliseconds == 0) {
            return newDuration(true, toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED,
                    toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, 0, 0, 0, 0);
        }
        ...
        if (milliseconds % 1000 == 0) {
            ...
            if (days <= ((long) Integer.MAX_VALUE)) {
                return newDuration(isPositive, toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED,
                        toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, (int) days, hours, minutes, seconds);
            }
            else {
     ...
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     */	
    public toolkit.xml.datatype.Duration newDurationDayTime(
            final boolean isPositive,
    ...
    public toolkit.xml.datatype.Duration newDurationDayTime(
        ...
        return newDuration(isPositive, 
                toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED,
     ...
     * 
     * <p>Both values are set and available from the created {@link toolkit.xml.datatype.Duration}</p>
     * 
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small values.
     * An {@link UnsupportedOperationException} will be thrown with a message indicating implementation limits
     ...
     * @throws NullPointerException If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public toolkit.xml.datatype.Duration newDurationYearMonth(final String lexicalRepresentation) {
        if (lexicalRepresentation == null) {
            throw new NullPointerException("The lexical representation cannot be null.");
        }
     ...
     * This is important as there are variations in the Gregorian Calendar,
     * e.g. leap years have different days in the month = {@link java.util.Calendar#FEBRUARY}
     * so the result of {@link toolkit.xml.datatype.Duration#getMonths()} can be influenced.</p>
     * 
     ...
     */
    public toolkit.xml.datatype.Duration newDurationYearMonth(final long durationInMilliseconds) {
     ...
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     */	
    public toolkit.xml.datatype.Duration newDurationYearMonth(
            final boolean isPositive,
     ...
     * 
     * <p>All date/time datatype fields set to {@link toolkit.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} or null.</p>
     * 
     * @return New <code>XMLGregorianCalendar</code> with all date/time datatype fields set to
     *   {@link toolkit.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} or null.
     */
    public abstract toolkit.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar();
     ...
     * @throws NullPointerException If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public abstract toolkit.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(final String lexicalRepresentation);
     ...
     *          {@link GregorianCalendar} to an {@link toolkit.xml.datatype.XMLGregorianCalendar}
     *       </th>
     *     </tr>
     *     <tr>
     *        <th><code>java.util.GregorianCalendar</code> field</th>
     *        <th><code>XMLGregorianCalendar</code> field</th>
     *     </tr>
     *   </thead>
     *   <tbody>
     *     <tr>
     *       <td><code>ERA == GregorianCalendar.BC ? -YEAR : YEAR</code></td>
     *       <td>{@link toolkit.xml.datatype.XMLGregorianCalendar#setYear(int year)}</td>
     *     </tr>
     *     <tr>
     *       <td><code>MONTH + 1</code></td>
     *       <td>{@link toolkit.xml.datatype.XMLGregorianCalendar#setMonth(int month)}</td>
     *     </tr>
     *     <tr>
     *       <td><code>DAY_OF_MONTH</code></td>
     *       <td>{@link toolkit.xml.datatype.XMLGregorianCalendar#setDay(int day)}</td>
     *     </tr>
     *     <tr>
     *       <td><code>HOUR_OF_DAY, MINUTE, SECOND, MILLISECOND</code></td>
     *       <td>{@link toolkit.xml.datatype.XMLGregorianCalendar#setTime(int hour, int minute, int second, BigDecimal fractional)}</td>
     *     </tr>
     *     <tr>
     *       <td>
     ...
     *         <em>(in minutes)</em>
     *       </td>
     *       <td>{@link toolkit.xml.datatype.XMLGregorianCalendar#setTimezone(int offset)}<sup><em>*</em></sup>
     *       </td>
     *     </tr>
     *   </tbody>
     * </table>
     ...
     */
    public abstract toolkit.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(final GregorianCalendar cal);
     ...
     *   as determined by the Date/Time Data Mapping table in {@link toolkit.xml.datatype.XMLGregorianCalendar}
     *   or if the composite values constitute an invalid <code>XMLGregorianCalendar</code> instance
     *   as determined by {@link toolkit.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public abstract toolkit.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(
            final BigInteger year,
            final int month,
     ...
     *   as determined by {@link toolkit.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public toolkit.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(
            final int year,
            final int month,
            final int day,
            final int hour,
        ...
        BigInteger realYear = (year != toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) year) : null;

        // millisecond may be undefined
        // millisecond must be >= 0 millisecond <= 1000
        BigDecimal realMillisecond = null; // undefined value
        if (millisecond != toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) {
     ...
     * {@link toolkit.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
     * 
     * <p>A {@link toolkit.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} value indicates that field is not set.</p>
     * 
     * @param year of <code>XMLGregorianCalendar</code> to be created.
     * @param month of <code>XMLGregorianCalendar</code> to be created.
     * @param day of <code>XMLGregorianCalendar</code> to be created.
     * @param timezone offset in minutes. {@link toolkit.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} indicates optional field is not set.
     * 
     * @return <code>XMLGregorianCalendar</code> created from parameter values.
     * 
     * @see toolkit.xml.datatype.DatatypeConstants#FIELD_UNDEFINED
     *
     * @throws IllegalArgumentException If any individual parameter's value is outside the maximum value constraint for the field
     *   as determined by the Date/Time Data Mapping table in {@link toolkit.xml.datatype.XMLGregorianCalendar}
     *   or if the composite values constitute an invalid <code>XMLGregorianCalendar</code> instance
     *   as determined by {@link toolkit.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public toolkit.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendarDate(
            final int year,
            final int month,
            final int day,
            final int timezone) {
        ...
        return newXMLGregorianCalendar(
                ...
                month,
                day,
                toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // hour
                toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // minute
                toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // second
                toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // millisecond
                timezone);
    }
     ...
     * @see toolkit.xml.datatype.DatatypeConstants#FIELD_UNDEFINED
     */
    public toolkit.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendarTime(
            final int hours,
            final int minutes,
            final int seconds,
            final int timezone) {
        ...
        return newXMLGregorianCalendar(
                toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Year
                toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Month
                toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Day
                hours,
                minutes,
                seconds,
                toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, //Millisecond
    ...
    public toolkit.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendarTime(
        ...
        if (milliseconds != toolkit.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) {
