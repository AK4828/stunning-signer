...
package toolkit.xml.bind;

import toolkit.xml.bind.annotation.XmlRootElement;
import toolkit.xml.bind.annotation.adapters.XmlAdapter;
import toolkit.xml.bind.attachment.AttachmentMarshaller;
import toolkit.xml.transform.Result;
import toolkit.xml.validation.Schema;
import java.io.File;

import toolkit.xml.bind.annotation.adapters.XmlJavaTypeAdapter;
import toolkit.xml.bind.helpers.DefaultValidationEventHandler;
import toolkit.xml.stream.XMLEventWriter;
import toolkit.xml.stream.XMLStreamWriter;
import toolkit.xml.stream.events.XMLEvent;
 ...
 *
 * <p>
 * Marshalling to a toolkit.xml.transform.SAXResult:
 * <blockquote>
 *    <pre>
 *       // assume MyContentHandler instanceof ContentHandler
 ...
 *
 * <p>
 * Marshalling to a toolkit.xml.transform.DOMResult:
 * <blockquote>
 *    <pre>
 ...
 *
 * <p>
 * Marshalling to a toolkit.xml.transform.StreamResult:
 * <blockquote>
 *    <pre>
 ...
 *
 * <p>
 * Marshalling to a XMLStreamWriter:
 * <blockquote>
 *    <pre>
 ...
 *
 * <p>
 * Marshalling to a XMLEventWriter:
 * <blockquote>
 *    <pre>
 ...
 * later versions, {@link DefaultValidationEventHandler} is
 * no longer used.
 * 
 * </blockquote>
 *
 ...
 *             generate an xml declaration.</li>
 *         <li>{@link #marshal(Object, Result) marshal(Object,Result)} - depends on the kind of
