...
import toolkit.xml.stream.XMLStreamWriter; // only for javadoc
...
/**
 * Extension of {@link XMLInputFactory} to add
    ...
    implements XMLStreamProperties
{
    ...
    public abstract XMLEventWriter createXMLEventWriter(XMLStreamWriter sw)
        throws XMLStreamException;
