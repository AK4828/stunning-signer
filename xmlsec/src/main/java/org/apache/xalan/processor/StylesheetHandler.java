        ...
        implements TemplatesHandler, PrefixResolver, NodeConsumer
{
   ...
   *
   * @throws TransformerException if the expression can not be processed.
   ...
   * @return A non-null reference to an XPath object that represents the string argument.
   *
   * @throws TransformerException if the pattern can not be processed.
   ...
   * to support the {@link PrefixResolver} interface,
   ...
   *
   * @param msg An key into the {@link XSLTErrorResources}
   ...
   * {@link TransformerException} if the current
   * {@link ErrorListener#warning}
   ...
   * exception.
   *
   * @param msg A key into the {@link XSLTErrorResources}
   * table, that is one of the WG_ prefixed definitions.
   * @param args An array of arguments for the given warning.
   * @param e An error which the SAXException should wrap.
   *
