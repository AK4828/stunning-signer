 ...
 *      <td>variables</td>
 *      <td>
 *        If the expression contains a variable reference, its value will be found through the {@link toolkit.xml.xpath.XPathVariableResolver}
 *        set with {@link #setXPathVariableResolver(toolkit.xml.xpath.XPathVariableResolver resolver)}.
 *        An {@link toolkit.xml.xpath.XPathExpressionException} is raised if the variable resolver is undefined or
 ...
 *      <td>functions</td>
 *      <td>
 *        If the expression contains a function reference, the function will be found through the {@link toolkit.xml.xpath.XPathFunctionResolver}
 *        set with {@link #setXPathFunctionResolver(toolkit.xml.xpath.XPathFunctionResolver resolver)}.
 *        An {@link toolkit.xml.xpath.XPathExpressionException} is raised if the function resolver is undefined or
 ...
 *        Valid return types are defined in {@link toolkit.xml.xpath.XPathConstants}.
...
public interface XPath {
	 ...
	 * 
	 * <p>The reset <code>XPath</code> is not guaranteed to have the same {@link toolkit.xml.xpath.XPathFunctionResolver}, {@link toolkit.xml.xpath.XPathVariableResolver}
     ...
     */
    public void setXPathVariableResolver(toolkit.xml.xpath.XPathVariableResolver resolver);
    ...
    /**
       ...
       */
    public toolkit.xml.xpath.XPathVariableResolver getXPathVariableResolver();
    ...
    /**
       ...
       * @throws NullPointerException If <code>resolver</code> is <code>null</code>.
       */
    public void setXPathFunctionResolver(toolkit.xml.xpath.XPathFunctionResolver resolver);
    ...
    /**
       ...
       */
    public toolkit.xml.xpath.XPathFunctionResolver getXPathFunctionResolver();
    ...
    /** 
       ...
       * 
       * <p>If <code>expression</code> contains any {@link toolkit.xml.xpath.XPathFunction}s,
       * they must be available via the {@link toolkit.xml.xpath.XPathFunctionResolver}.
       * An {@link toolkit.xml.xpath.XPathExpressionException} will be thrown if the <code>XPathFunction</code>
       ...
       * @throws toolkit.xml.xpath.XPathExpressionException If <code>expression</code> cannot be compiled.
       * @throws NullPointerException If <code>expression</code> is <code>null</code>.
       */
    public toolkit.xml.xpath.XPathExpression compile(String expression)
        throws toolkit.xml.xpath.XPathExpressionException;
     ...
     * 
     * <p>If <code>returnType</code> is not one of the types defined in {@link toolkit.xml.xpath.XPathConstants} (
     * {@link toolkit.xml.xpath.XPathConstants#NUMBER NUMBER},
     * {@link toolkit.xml.xpath.XPathConstants#STRING STRING},
     * {@link toolkit.xml.xpath.XPathConstants#BOOLEAN BOOLEAN},
     * {@link toolkit.xml.xpath.XPathConstants#NODE NODE} or
     * {@link toolkit.xml.xpath.XPathConstants#NODESET NODESET})
     ...
     * 
     * @throws toolkit.xml.xpath.XPathExpressionException If <code>expression</code> cannot be evaluated.
     * @throws IllegalArgumentException If <code>returnType</code> is not one of the types defined in {@link toolkit.xml.xpath.XPathConstants}.
     ...
     * {@link toolkit.xml.xpath.XPathConstants#STRING}.</p>
     * 
     * <p>See <a href="#XPath-evaluation">Evaluation of XPath Expressions</a> for context item evaluation,
     ...
     * 
     * @throws toolkit.xml.xpath.XPathExpressionException If expression cannot be evaluated.
     * @throws IllegalArgumentException If <code>returnType</code> is not one of the types defined in {@link toolkit.xml.xpath.XPathConstants}.
     ...
     * <code>returnType</code> of {@link toolkit.xml.xpath.XPathConstants#STRING}.</p>
     *
     * <p>See <a href="#XPath-evaluation">Evaluation of XPath Expressions</a> for context item evaluation,
     * variable, function and QName resolution and return type conversion.</p>
     * 
