 ...
 * One is {@link toolkit.xml.validation.Validator}, which provides highly-level validation
 * operations that cover typical use cases. The other is
 * {@link toolkit.xml.validation.ValidatorHandler}, which works on top of SAX for better
 * modularity.
 * 
 * <p>
...
public abstract class Schema {
    ...
    /**
     * Creates a new {@link toolkit.xml.validation.Validator} for this {@link Schema}.
     * 
     * <p>
     ...
     */
    public abstract toolkit.xml.validation.Validator newValidator();
    
    /**
     * Creates a new {@link toolkit.xml.validation.ValidatorHandler} for this {@link Schema}.
     * 
     * @return
     *      Always return a non-null valid object.
     */
    public abstract toolkit.xml.validation.ValidatorHandler newValidatorHandler();
}
