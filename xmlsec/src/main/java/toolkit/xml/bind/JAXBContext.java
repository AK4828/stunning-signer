 ...
 * contain a property named <tt>toolkit.xml.bind.context.factory</tt> whose
 ...
 * <tt>JAXBContext</tt>, it simply has to provide a class that
 ...
 * the JAXP 1.3 {@link toolkit.xml.validation} framework.  Please refer to the
 * {@link Unmarshaller#setSchema(Schema)} API for more
 * information.
 *
 * 
 ...
 *
 * <li>
 * Look for <tt>/META-INF/services/JAXBContext</tt> file in the associated classloader.
...
public abstract class JAXBContext {
    ...
    public static final String JAXB_CONTEXT_FACTORY = 
        "toolkit.xml.bind.context.factory";
     ...
     * <tt>toolkit.xml.bind.context.factory</tt> property and that all values
