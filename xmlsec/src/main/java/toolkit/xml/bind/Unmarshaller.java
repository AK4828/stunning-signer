...
import toolkit.xml.bind.attachment.AttachmentUnmarshaller;
import toolkit.xml.stream.XMLEventReader;
 ...
 * 
 * <p>
 * Unmarshalling from a <tt>SAXSource</tt> using a
 ...
 *
 *       System.setProperty( "SAXParserFactory",
 ...
 * time. See {@link #unmarshal(Source) unmarshal(Source)}
 * for more detail.
 * </blockquote>
 *
 * <p>
 ...
 * mechanism via the <tt>setSchema(Schema)</tt> API.
 ...
 * {@link #unmarshal(Source) unmarshal(Source)}  API.
 * 
 * <p>
 ...
 * {@link DefaultValidationEventHandler} and it
