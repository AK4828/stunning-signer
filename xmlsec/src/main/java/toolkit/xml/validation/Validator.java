...
import toolkit.xml.transform.stax.StAXResult;
...
public abstract class Validator {
     ...
     *  <tr>
     *   <td></td>
     *   <td>{@link SAXSource}</td>
     *   <td>{@link DOMSource}</td>
     *   <td>{@link StAXSource}</td>
     *   <td>{@link StreamSource}</td>
     *  </tr>
     * </thead>
     * <tbody>
     *  <tr>
     ...
     * (see {@link TransformerFactory#newTransformer()}).
     * 
     * <p>
     ...
     *      in it.
     *      
     *      Note that when a {@link DOMResult} is used,
