...
/**
 * Implementation of {@link toolkit.xml.validation.SchemaFactory#newInstance(String)}.
 * 
...
final class SchemaFactoryFinder  {
     ...
     * 
     * @param loader
     *      to be used to load resource, {@link toolkit.xml.validation.SchemaFactory}, and
    ...
    /**
     * <p>Creates a new {@link toolkit.xml.validation.SchemaFactory} object for the specified
     * schema language.</p>
     * 
     * @param schemaLanguage
     *      See {@link toolkit.xml.validation.SchemaFactory Schema Language} table in <code>SchemaFactory</code>
     ...
     */
    public toolkit.xml.validation.SchemaFactory newFactory(String schemaLanguage) {
        if(schemaLanguage==null)        throw new NullPointerException();
        toolkit.xml.validation.SchemaFactory f = _newFactory(schemaLanguage);
        if (debug) {
            if (f != null) {
     ...
     */
    private toolkit.xml.validation.SchemaFactory _newFactory(String schemaLanguage) {
        toolkit.xml.validation.SchemaFactory sf;
     ...
     */
    toolkit.xml.validation.SchemaFactory createInstance( String className ) {
        try {
            ...
            if( o instanceof toolkit.xml.validation.SchemaFactory)
                return (toolkit.xml.validation.SchemaFactory)o;
    ...
    private toolkit.xml.validation.SchemaFactory loadFromServicesFile(String schemaLanguage, String resourceName, InputStream in) {
        ...
        String factoryClassName = null;
        toolkit.xml.validation.SchemaFactory resultFactory = null;
        ...
        while (true) {
            ...
            if (factoryClassName != null) {
                ...
                try {
                    ...
                    toolkit.xml.validation.SchemaFactory foundFactory = (toolkit.xml.validation.SchemaFactory) createInstance(factoryClassName);
    ...
    private static final Class SERVICE_CLASS = toolkit.xml.validation.SchemaFactory.class;
