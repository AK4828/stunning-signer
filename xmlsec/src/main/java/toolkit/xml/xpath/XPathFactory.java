 ...
 * {@link toolkit.xml.xpath.XPath} objects.</p>
 *
...
public abstract class XPathFactory {
     ...
     */
    public static final String DEFAULT_PROPERTY_NAME = "XPathFactory";
    ...
    public static final XPathFactory newInstance() {
    	...
    	catch (toolkit.xml.xpath.XPathFactoryConfigurationException xpathFactoryConfigurationException) {
    ...
    *   </li>
    *   <li>
    *     The class loader is asked for service provider provider-configuration files matching <code>XPathFactory</code>
    ...
    * @return Instance of an <code>XPathFactory</code>.
    * 
    * @throws toolkit.xml.xpath.XPathFactoryConfigurationException If the specified object model is unavailable.
    ...
    */
    public static final XPathFactory newInstance(final String uri)
        throws toolkit.xml.xpath.XPathFactoryConfigurationException {
        if (uri == null) {
        ...
        if (xpathFactory == null) {
            throw new toolkit.xml.xpath.XPathFactoryConfigurationException(
    ...
    public static XPathFactory newInstance(String uri, String factoryClassName,
            ClassLoader classLoader) throws toolkit.xml.xpath.XPathFactoryConfigurationException {
        if (uri == null) {
            throw new NullPointerException(
                "XPathFactory#newInstance(String uri) cannot be called with uri == null"
            );
        ...
        if (factoryClassName == null) {
            throw new toolkit.xml.xpath.XPathFactoryConfigurationException("factoryClassName cannot be null.");
        }
        if (classLoader == null) {
     ...
     * An {@link toolkit.xml.xpath.XPathFactoryConfigurationException} is thrown if this <code>XPathFactory</code> or the <code>XPath</code>s
     ...
     * Under these conditions, the implementation must not call the {@link toolkit.xml.xpath.XPathFunctionResolver}
     ...
     *  
     * @throws toolkit.xml.xpath.XPathFactoryConfigurationException if this <code>XPathFactory</code> or the <code>XPath</code>s
     ...
     */
    public abstract void setXPathVariableResolver(toolkit.xml.xpath.XPathVariableResolver resolver);
    ...
    /**
       ...
       * @throws NullPointerException If <code>resolver</code> is <code>null</code>.
       */
    public abstract void setXPathFunctionResolver(toolkit.xml.xpath.XPathFunctionResolver resolver);
    ...
    */
    public abstract toolkit.xml.xpath.XPath newXPath();
}
